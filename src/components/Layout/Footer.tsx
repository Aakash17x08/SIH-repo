    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
                ...
                <span className="text-xl font-bold">CampusRoot</span>
            </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="/directory" className="text-gray-400 hover:text-white transition-colors">Alumni Directory</a></li>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-400">123 University Ave, Campus City, UC 12345</span>
              </div>
              <div className="flex items-center space-x-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-400">alumni@university.edu</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400 text-sm">
            © 2025 CampusRoot. All rights reserved. Built with ❤️ for our alumni community.
          </p>
        </div>
      </div>
    </footer>
